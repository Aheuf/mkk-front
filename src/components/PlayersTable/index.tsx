...
export default function PlayersTable({ players, onClickPlayerHp, onClickPlayerDelete, className }: PlayersTableProps) {
    return (
        <table className={`text-white table-auto bg-white/50 mario-font text-3xl w-2/3 rounded ${className ?? ""}`}>
            <thead>
                <tr>
                    <th>joueur</th>
                    <th>vie</th>
